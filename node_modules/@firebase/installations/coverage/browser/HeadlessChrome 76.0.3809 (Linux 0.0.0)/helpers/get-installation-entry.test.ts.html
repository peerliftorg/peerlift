...
<html lang="en">
<head>
    <title>Code coverage report for helpers/get-installation-entry.test.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">helpers</a> get-installation-entry.test.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">99.06% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>210/212</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>163/165</span>
      </div>
    </div>
    <p class="quiet">
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (installationEntry.registrationStatus !== RequestStatus.IN_PROGRESS) {
<span class="cstat-no" title="statement not covered" >        throw new AssertionError('InstallationEntry is not IN_PROGRESS.');</span>
      }
&nbsp;
      expect(registrationPromise).to.be.an.instanceOf(Promise);
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Aug 01 2019 13:13:38 GMT-0700 (PDT)
</div>
</div>
